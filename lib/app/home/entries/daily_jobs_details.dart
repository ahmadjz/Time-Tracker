import 'package:time_tracker/app/home/entries/entry_job_model.dart';
...
class DailyJobsDetails {
  ...
  static Map<DateTime, List<EntryJobModel>> _entriesByDate(
      List<EntryJobModel> entries) {
    Map<DateTime, List<EntryJobModel>> map = {};
  ...
  static List<DailyJobsDetails> all(List<EntryJobModel> entries) {
  ...
  static List<JobDetails> _jobsDetails(List<EntryJobModel> entries) {
